...
///     with enums and convert them to strings, or other symbols. I don't know the specific name of
///     this pattern but I'm sure wiser devs have already thought of it.
///
...
///
/// 2.Create an enum from an applied list by calling CND_MM_CREATE_ENUM_FROM_APPLIED_ENUM(ln, en,
/// et) or
///   CND_MM_CREATE_ENUM_FROM_APPLIED_ENUM_UNTYPED(ln, en) - based on wether you need a typed of
...
/// CND_MM_CREATE_ENUMTOCSTR_FROM_ENUM_LIST(fn, ln, en).
///   @see CND_MM_CREATE_ENUMTOCSTR_FROM_ENUM_LIST
///
...
/// Enum must be defined using CND_MM_CREATE_ENUM_FROM_APPLIED_ENUM
/// 
/// Use the following format where [] is the substitute pattern:
/// @code
