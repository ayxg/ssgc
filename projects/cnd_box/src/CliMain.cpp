...
//  // Parse global flags & main command
//  Vec<StrView> args{argv, argv + argc};
//  cnd::driver::parsers::MainCliParser::FlagMapType parsed_flags{};
//  cldev::util::Logger log{cldev::util::gStdLog()}; 
//  cnd::driver::parsers::MainCliParser main_parser{};
//  auto main_parse_res = main_parser.Parse(args.begin(),args.end(),parsed_flags);
//  if (!main_parse_res) {
//    log.GetErrStream() << main_parse_res.error();
//    return EXIT_FAILURE;
//  }
//  
//
...
//  auto cli_res = CliMainInternal(argc, argv, envp);
//  if (!cli_res) return EXIT_FAILURE;
//  if (std::holds_alternative<int>(*cli_res))
//    return std::get<int>(*cli_res);
//  else
//    return std::get<TrOutput>(*cli_res).exit_code;
//}
//}  // namespace cnd
//
