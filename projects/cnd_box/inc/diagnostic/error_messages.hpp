...
CND_MM_CLMSG_MAKE_FNSIG(eClErr, kLexerUnclosedCharacterLiteral) {
  return ClMsgUnion{ClMsgNode{GetClMsgIdOf(THIS_MESSAGE_ENUM), {}}};
}

CND_MM_CLMSG_FORMAT_FNSIG(eClErr, kLexerUnclosedCharacterLiteral) {
...
CND_MM_CLMSG_MAKE_FNSIG(eClErr, kLexerEmptyCharacterLiteral) {
  return ClMsgUnion{ClMsgNode{GetClMsgIdOf(THIS_MESSAGE_ENUM), {}}};
}

CND_MM_CLMSG_FORMAT_FNSIG(eClErr, kLexerEmptyCharacterLiteral) {
