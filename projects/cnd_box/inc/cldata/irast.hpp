...
//// clang-format on
//
//namespace cnd::cldata::irast {
//template <class T>
//using ClResult = CompilerProcessResult<T>;
//using ClFail = CompilerProcessFailure;
//using CppSrcLoc = std::source_location;
//
//#define CL_FAIL(msg) ClFail(MakeClMsg<eClErr::kCompilerDevDebugError>(CppSrcLoc{}, msg));
//
...
//using CtInt = long long int;
//using CtUint = long long unsigned;
//using CtReal = double;
//using CtBool = bool;
//using CtChar = char;
...
//  ClResult<PrimaryExpr> ReduceConsteval() {}
//
...
//  ClResult<PrimaryExpr> ReduceConstexpr() {}
//
//  static ClResult<PrimaryExpr> FromAst(const Ast& ast, Program& program);
//};
//
...
//  static ClResult<LitInt> FromAst(const Ast& ast);
//};
//struct LitUint {
//  CtUint val;
//  static LitUint Create(CtUint&& v);
//  static ClResult<LitUint> FromAst(const Ast& ast);
//};
//struct LitReal {
//  CtReal val;
//  static LitReal Create(CtReal&& v);
//  static ClResult<LitReal> FromAst(const Ast& ast);
//};
//struct LitBool {
//  CtBool val;
//  static LitBool Create(CtBool&& v);
//  static ClResult<LitBool> FromAst(const Ast& ast);
//};
//struct LitChar {
//  CtChar val;
//  static LitChar Create(CtChar&& v);
//  static ClResult<LitChar> FromAst(const Ast& ast);
//};
//struct LitByte {
//  CtByte val;
//  static LitByte Create(CtByte&& v);
//  static ClResult<LitByte> FromAst(const Ast& ast);
//};
//struct LitCstr {
//  CtCstr val;
//  static LitCstr Create(CtCstr&& v);
//  static ClResult<LitCstr> FromAst(const Ast& ast);
//};
//struct Ident {
//  CtCstr name;
//  static Ident Create(CtCstr&& v);
//  static ClResult<Ident> FromAst(const Ast& ast);
//};
//
//struct ValList {
...
//  Ident name;
//  PrimaryExpr type;
//  static ClResult<UsingDecl> FromAst(const Ast& ast, Program& program, NamespaceDecl& ns, size_t& eval_order);
//};
//struct NamespaceDecl {
//  size_t eval_order;
...
//  static ClResult<NamespaceDecl*> FromAst(const Ast& ast, Program& program, NamespaceDecl& ns, size_t& eval_order);
//};
//
////---------------------------------------------------------//
//// Class:{VarDecl}
...
//                                //     Vec<Ident>{"__global__","Details",'hidden'}
//  ValMods mods{};
//  TypeList constraints{};
//  bool is_invariant{};
//  bool is_initialized{};
//  PrimaryExpr initializer{};
//  static ClResult<VarDecl*> FromAst(const Ast& ast, Program& program, NamespaceDecl& context, size_t& eval_order,
//                                    eVarDeclCategory decl_category);
//  constexpr VarDecl() {}
//  constexpr VarDecl& operator=(const VarDecl& rhs) { return *this; }
//};
//
//struct FnDecl {
//  size_t eval_order;
...
//  Vec<UsingDecl> typedefs;
//
//  static ClResult<FnDecl*> FromAst(const Ast& ast, Program& program, NamespaceDecl& ns, size_t& eval_order);
//};
//struct ClassDecl {
//  size_t eval_order;
//  Ident name;
...
//  FnDecl main_fn;
//  Vec<ClassDecl*> defined_types;
//  static Program Create();
//  static ClResult<Program> FromAst(const Ast& ast);
//};
//struct TranslationFragment {
//  NamespaceDecl global_ns;
//  Vec<Program> proc_defs;
//};
...
/////////////////////////////////////////////////////////////////////////////////
//
//ClResult<LitInt> LitInt::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kLitInt)) {
//    return CL_FAIL("ClResult LiteralInt");
//  }
//
//  CtInt value{};
//  try {
...
//    return CL_FAIL("[consteval] IntegerOverflow");
//  }
//  return ClResult<LitInt>::Success(LitInt{.val = value});
//}
//
//ClResult<LitUint> LitUint::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kLitUint)) {
//    return CL_FAIL("ClResult LiteralUint");
//  }
//
//  if (ast.GetLiteral().back() != 'u') {
//    return CL_FAIL("CUnsignedEval:Unsigned literal not followed by 'u':" + ast.GetLiteral());
//  }
//  auto unsigned_str = ast.GetLiteral().substr(0, ast.GetLiteral().size() - 1);
//
//  LitUint ret{};
//  try {
//    ret.val = std::stoull(unsigned_str);
//  } catch (std::exception&) {
//    return CL_FAIL("[consteval] Unsigned int overflow.");
//  }
//  return ClResult<LitUint>::Success(std::move(ret));
//}
//
//ClResult<LitReal> LitReal::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kLitReal)) {
//    return CL_FAIL("ClResult LiteralReal");
//  }
//
//  LitReal ret{};
//
//  try {
//    ret.val = std::stod(ast.GetLiteral());
//  } catch (std::exception&) {
//    return CL_FAIL("[consteval] Failed to parse literal real: " + ast.GetLiteral());
//  }
//  return ClResult<LitReal>::Success(std::move(ret));
//}
//
//ClResult<LitBool> LitBool::FromAst(const Ast& ast) {
//  LitBool ret{};
//  if (ast.TypeIs(eCst::kLitBool)) {
//    if (ast.GetLiteral() == "1b") {
//      ret.val = true;
//    } else if (ast.GetLiteral() == "0b") {
//      ret.val = false;
//    } else {
//      return CL_FAIL("CevalInvalidBoolLiteral");
//    }
//  } else if (ast.TypeIs(eCst::kKwTrue))
//    ret.val = true;
//  else if (ast.TypeIs(eCst::kKwTrue))
//    ret.val = false;
//  else
//    return CL_FAIL("CevalInvalidBoolLiteral");
//  return ClResult<LitBool>::Success(std::move(ret));
//}
//
//ClResult<LitByte> LitByte::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kLitByte)) {
//    return CL_FAIL("ClResult LiteralByte");
//  }
//  if (ast.GetLiteral().back() != 'B') {
//    return CL_FAIL("CUnsignedEval:Unsigned literal not followed by 'B':" + ast.GetLiteral());
//  }
//  auto byte_str = ast.GetLiteral().substr(0, ast.GetLiteral().size() - 1);
//
//  LitByte ret{};
//  try {
//    ret.val = static_cast<unsigned char>(std::stoi(byte_str));
//  } catch (std::exception&) {
//    return CL_FAIL("CevalInvalidByteLiteral");
//  }
//  return ClResult<LitByte>::Success(std::move(ret));
//}
//
//ClResult<LitChar> LitChar::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kLitChar)) {
//    return CL_FAIL("ClResult LiteralChar");
//  }
//  // literal will be in the form [0-255]c or '[character]'c
//  if (ast.GetLiteral().back() != 'c') {
//    return CL_FAIL(("COctetEval:Octet literal not followed by 'c'" + ast.GetLiteral()));
//  }
//  LitChar ret{};
//  // if the literal is a character
//  if (ast.GetLiteral()[0] == '\'') {
//    auto byte_str = ast.GetLiteral().substr(1, ast.GetLiteral().size() - 3);  // remove the quotes and the c
//    // Check for escape characters.
//    auto escape_pos = byte_str.find('\\');
//    if (escape_pos != std::string::npos) {
//      // Replace the escape characters
//      switch (ast.GetLiteral()[escape_pos + 1]) {
//        case 'n':
...
//          break;
//        default:
//          return CL_FAIL("COctetEval:Invalid escape character:" + ast.GetLiteral());
//      }
//    }
//    if (byte_str.size() != 1) {
//      return CL_FAIL("COctetEval:Invalid character literal:" + ast.GetLiteral());
//    }
...
//  }
//  return ClResult<LitChar>::Success(std::move(ret));
//}
//
//ClResult<LitCstr> LitCstr::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kLitCstr)) {
//    return CL_FAIL("ClResult LiteralCstr");
//  }
...
//
//  // Check for escape characters.
//  // If there are escape characters, we need to replace them with their actual
//  // values.
...
//          break;
//        default:
//          return CL_FAIL("CStringEval:Invalid escape character:" + literal);
//      }
//    }
//  }
//  return ClResult<LitCstr>::Success(LitCstr{.val = std::move(literal)});
//}
//
//ClResult<Ident> Ident::FromAst(const Ast& ast) {
//  if (ast.TypeIsnt(eCst::kIdent)) {
//    return CL_FAIL("ClResult Identifier");
//  }
//  return ClResult<Ident>::Success(Ident{.name = ast.GetLiteral()});
//}
//
//ClResult<PrimaryExpr> OpAdd::FromAst(const Ast& ast, Program& program) {
//  // Both sides are literal values ->
...
//      if (!lhs_lit) return ClFail{lhs_lit.error()};
//      auto rhs_lit = PrimaryExpr::FromAst(rhs, program);
//      if (!rhs_lit) return ClFail{rhs_lit.error()};
//      // Perform the operation
//      // auto result = CtAddOp(lhs_lit.Extract(), rhs_lit.Extract());
//      return CL_FAIL("NOT IMPLEMENTED");
//    } else if (lhs.TypeIs(eCst::kIdent)) {
//      // PrimaryExpr ident_val_ir = program.Resolve(ns, lhs);
//      // if (ident_val_ir.IsConsteval()) ident_val_ir.Solve();
//    }
//  }
//}
//
//ClResult<Program> Program::FromAst(const Ast& ast) {
//  // 1. Root ast must be a program.
//  if (ast.TypeIsnt(eCst::kProgram)) {
//    return CL_FAIL("Root ast must be a program.");
//  }
//
...
//    if (!IsCstPragmatic(stmt.type)) {
//      return CL_FAIL("All statements must be pragmatic at the top level.");
//    }
//    // Generate IrAst for the statements.
//    // Keep track of the order of evaluation
//    if (stmt.TypeIs(eCst::kVariableDeclaration) || stmt.TypeIs(eCst::kVariableDefinition)) {
//      auto var_def_ir = VarDecl::FromAst(stmt, program, program.global_ns, eval_order);
//      if (not var_def_ir) return ClResult<Program>::Failure(var_def_ir.error());
//    } else if (stmt.TypeIs(eCst::kMethodDeclaration) || stmt.TypeIs(eCst::kMethodDefinition)) {
//      auto fn_def_ir = FnDecl::FromAst(stmt, program, program.global_ns, eval_order);
//      if (not fn_def_ir) return ClResult<Program>::Failure(fn_def_ir.error());
//    } else if (stmt.TypeIs(eCst::kKwUse)) {
//      auto use_def_ir = UsingDecl::FromAst(stmt, program, program.global_ns, eval_order);
//      if (not use_def_ir) return ClResult<Program>::Failure(use_def_ir.error());
//    } else if (stmt.TypeIs(eCst::kClassDeclaration)) {
//      auto use_def_ir = UsingDecl::FromAst(stmt, program, program.global_ns, eval_order);
//      if (not use_def_ir) return ClResult<Program>::Failure(use_def_ir.error());
//    } else if (stmt.TypeIs(eCst::kKwNamespace)) {
//      auto use_def_ir = UsingDecl::FromAst(stmt, program, program.global_ns, eval_order);
//      if (not use_def_ir) return ClResult<Program>::Failure(use_def_ir.error());
//    }
//  }
//  // 4. Return the program.
//  return ClResult<Program>::Success(program);
//}
//
//ClResult<NamespaceDecl*> NamespaceDecl::FromAst(const Ast& ast, Program& program, NamespaceDecl& ns,
//                                                size_t& eval_order) {
//  if (ast.TypeIsnt(eCst::kKwNamespace)) {
//    return CL_FAIL("ClResult Namespace Declaration");
//  }
//  // Get the namespace name
//  auto ns_name = Ident::FromAst(ast.children[0]);
//  if (not ns_name) return ClResult<NamespaceDecl*>::Failure(ns_name.error());
...
//        if (!var_def_ir) return ClResult<NamespaceDecl*>::Failure(var_def_ir.error());
//      } else if (stmt.TypeIs(eCst::kMethodDeclaration) || stmt.TypeIs(eCst::kMethodDefinition)) {
//        auto fn_def_ir = FnDecl::FromAst(stmt, program, existing_ns, internal_eval_order);
//        if (!fn_def_ir) return ClResult<NamespaceDecl*>::Failure(fn_def_ir.error());
//      } else if (stmt.TypeIs(eCst::kKwUse)) {
//        auto use_def_ir = UsingDecl::FromAst(stmt, program, existing_ns, internal_eval_order);
//        if (!use_def_ir) return ClResult<NamespaceDecl*>::Failure(use_def_ir.error());
//      } else if (stmt.TypeIs(eCst::kClassDeclaration)) {
//        auto use_def_ir = UsingDecl::FromAst(stmt, program, existing_ns, internal_eval_order);
//        if (!use_def_ir) return ClResult<NamespaceDecl*>::Failure(use_def_ir.error());
//      } else if (stmt.TypeIs(eCst::kKwNamespace)) {
...
//      }
//    }
//    return ClResult<NamespaceDecl*>::Success(&existing_ns);
//  }
...
//      return CL_FAIL("Namespace cannot have the same name as a class.");
//    }
//    if (ns.typedefs.cend() != std::find(ns.typedefs.cbegin(), ns.typedefs.cend(),
//                                        [&ns_name](const auto& v) { return ns_name.value().name == v.name; })) {
//      return CL_FAIL("Namespace cannot have the same name as a typedef.");
//    }
//    if (ns.fields.contains(ns_name.value().name)) {
//      return CL_FAIL("Namespace cannot have the same name as a variable.");
//    }
...
//    ns_decl.name = move(ns_name.value());
//
...
//    return ClResult<NamespaceDecl*>::Success(&ns_decl);
//  }
//}
//
//ClResult<VarDecl*> VarDecl::FromAst(const Ast& ast, Program& program, NamespaceDecl& context, size_t& eval_order,
//                                    eVarDeclCategory decl_category) {
//  if (!(ast.TypeIs(eCst::kVariableDeclaration) || ast.TypeIs(eCst::kVariableDefinition)))
//    return CL_FAIL("Root ast must be VariableDeclaration or VariableDefinition");
//
...
//  auto var_name = Ident::FromAst(ast.children[2]);
//  if (!var_name) return ClResult<VarDecl*>::Failure(var_name.error());
//
...
//      return CL_FAIL("Variable name must be unique in the namespace.");
//
//  // 3. Create a new variable definition.
//  context.fields[var_name.value().name] = VarDecl{};
//  VarDecl& var_def = context.fields[var_name.value().name];
//  var_def.eval_order = eval_order;
//  var_def.name = var_name.value();
...
//  if (ast.TypeIs(eCst::kVariableDeclaration)) {
//    // -> Const ?
//    if (var_def.mods.is_const) {
//      return ClResult<VarDecl*>::Failure("Constant values must be explicitly initialized.");
//    }
...
//      return ClResult<VarDecl*>::Failure(
...
//    }
//  }
//  return ClResult<VarDecl*>::Success(&var_def);
//}
//
//ClResult<FnDecl*> FnDecl::FromAst(const Ast& ast, Program& program, NamespaceDecl& ns, size_t& eval_order) {
//  // 1. Root must be a fn def or fn decl.
//  if (not(ast.TypeIs(eCst::kMethodDeclaration) || ast.TypeIs(eCst::kMethodDefinition))) {
//    return cxx::ClResult<FnDecl*>::Failure("Root ast must be MethodDeclaration or MethodDefinition");
//  }
//  // 2. Make sure the function name is unique in the namespace.
//  auto fn_name = Ident::FromAst(ast[2]);
//  if (not fn_name) return ClResult<FnDecl*>::Failure(fn_name.Error());
//  if (ns.methods.contains(fn_name.Value().name)) {
//    return ClResult<FnDecl*>::Failure("Function name must be unique in the namespace.");
//  }
//
...
//      return ClResult<FnDecl*>::Failure("All statements must be functional at the function level.");
//    }
//    auto stmt_ir = FunctionalStmt::FromAst(stmt, program);
//    if (not stmt_ir) return stmt_ir;
//    fn_def.definition.push_back(stmt_ir.Extract());
//  }
//  return ClResult<FnDecl*>::Success(&fn_def);
//}
//
//ClResult<UsingDecl*> UsingDecl::FromAst(const Ast& ast, Program& program, NamespaceDecl& ns, size_t& eval_order) {
//  if (ast.TypeIsnt(eCst::kKwUse)) {
//    return ClResult<UsingDecl>::Failure("ClResult Using Declaration");
//  }
//
//  // Make sure the using name is unique in the namespace.
//  auto using_name = Ident::FromAst(ast[0]);
//  if (not using_name) return ClResult<UsingDecl>::Failure(using_name.error());
...
//    return ClResult<UsingDecl>::Failure("Using name must be unique in the namespace.");
//  }
//
...
//    return ClResult<UsingDecl>::Failure("Using declaration must be const_evaluable.");
//  }
//  auto primary_type = primary_type_expr.Value().GetAstTypelist();
//  if (not primary_type)
//    return ClResult<UsingDecl>::Failure(
...
//}
//
//ClResult<ClassDecl*> ClassDecl::FromAst(const Ast& ast, Program& program, NamespaceDecl& ns, size_t& eval_order) {
//  if (ast.TypeIsnt(eCst::kClassDeclaration)) {
//    return ClResult<ClassDecl*>::Failure("ClResult Class Declaration");
//  }
//  // Get the class name
//  auto class_name = Ident::FromAst(ast[0]);
//  if (not class_name) return ClResult<ClassDecl*>::Failure(class_name.Error());
//  // Check if the class is already defined.
//  if (ns.classes.contains(class_name.Value().name)) {
//    return ClResult<ClassDecl*>::Failure("Class name must be unique in the namespace.");
//  }
...
//      return ClResult<ClassDecl*>::Failure("All statements must be declarative at the class level.");
//    }
//    if (stmt.TypeIs(eCst::kVariableDeclaration) || stmt.TypeIs(eCst::kVariableDefinition)) {
//      auto var_def_ir = VarDecl::FromAst(stmt, program, class_decl, eval_order);
//      if (not var_def_ir) return ClResult<ClassDecl*>::Failure(var_def_ir.Error());
//    } else if (stmt.TypeIs(eCst::kMethodDeclaration) || stmt.TypeIs(eCst::kMethodDefinition)) {
//      auto fn_def_ir = FnDecl::FromAst(stmt, program, class_decl, eval_order);
//      if (not fn_def_ir) return ClResult<ClassDecl*>::Failure(fn_def_ir.Error());
//    } else if (stmt.TypeIs(eCst::kKwUse)) {
//      auto use_def_ir = UsingDecl::FromAst(stmt, program, class_decl, eval_order);
//      if (not use_def_ir) return ClResult<ClassDecl*>::Failure(use_def_ir.Error());
//    } else if (stmt.TypeIs(eCst::kClassDeclaration)) {
//      auto use_def_ir = UsingDecl::FromAst(stmt, program, class_decl, eval_order);
//      if (not use_def_ir) return ClResult<ClassDecl*>::Failure(use_def_ir.Error());
//    } else if (stmt.TypeIs(eCst::kKwNamespace)) {
...
//  return ClResult<ClassDecl*>::Success(&class_decl);
//}
//
//}  // namespace cnd::cldata::irast
//
