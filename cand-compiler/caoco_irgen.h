...
// File: caoco_irgen.h
//---------------------------------------------------------------------------//
#ifndef HEADER_GUARD_CALE_CAND_OFFICIAL_COMPILER_CAOCO_IRGEN_H
#define HEADER_GUARD_CALE_CAND_OFFICIAL_COMPILER_CAOCO_IRGEN_H
//---------------------------------------------------------------------------//
...
class IrGen {
  ...
  void GenVariableDeclaration(const Ast& ast) {
    ...
    auto& var_decl_line =
        ir.AddLine(line_index, eIrOp::DECLARE_VARIABLE, kIrOpNullArguments);
    line_index++;
    ...
    if (ast.Size() == 4) {
      ...
      const auto& initializer_ast =
          ast[3][0];  // Get first child of initializer
...
// File: caoco_irgen.h
//---------------------------------------------------------------------------//
#endif HEADER_GUARD_CALE_CAND_OFFICIAL_COMPILER_CAOCO_IRGEN_H
//---------------------------------------------------------------------------//
//---------------------------------------------------------------------------//
