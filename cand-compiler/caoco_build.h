...
//
//struct SourceFile {
//  using data_type = std::map<size_t, std::map<size_t, char>>;
//  using line_data_type = std::map<size_t, char>;
//  stdfs::path path;
...
//
//struct FlatSource {
//  using data_type = std::map<stdfs::path, SourceFile>;
//  template <class T>
...
//
//  for (const auto& line : loaded_file.second) {
...
//    return caerr::MakeError(caerr::CustomError(loaded_file.first.string()));
//  }
//
